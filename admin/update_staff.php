...
$query = "SELECT uid, username, fname, lname, nic, gender, dob, address, phone, email, role FROM user WHERE uid = '$uid' AND (role = 'cashier' OR role = 'manager' OR role = 'security' OR role = 'admin') LIMIT 1";
...
if ($result && mysqli_num_rows($result) != 1) {
    echo '<script>alert("User not found"); window.location.href = "./staff.php";</script>';
    exit();
}
...
<head>
    ...
    <!-- meta tags -->
    <meta name="title" content="Admin | Register Staff | Ceft Online">
    ...
    <meta property="og:title" content="Admin | Register Staff | Ceft Online">
    ...
    <meta property="twitter:card" content="Admin | Register Staff | Ceft Online">
    <meta property="twitter:url" content="https://www.ceft.online/">
    <meta property="twitter:title" content="Admin | Register Staff | Ceft Online">
...
<div class="dashboard-board">
    ...
    <div class="container breadcrumb">
        ...
        <span>></span>
        <a href="./update_staff.php?uid=<?php echo $uid; ?>">Update Staff Member</a>
    </div>
    ...
    <div class="dash-container container-mid">
        <div class="contact-form" id="dash1">
            ...
            <div class="login-main-side container-mid login-grid-1" style="padding: 20px 30px;">
                <h1 style="margin: 10px 0;">Update Staff Member</h1>
            </div>

            <form action="../backend/admin/staff/update.php" method="post">
                ...
                <select class="login-input" name="role" id="role" style="height: inherit;">
...
<script>
    // alert box
    alertBox("Staff member updated successfully!", "Staff member update failed!");
