...
<div class="dashboard-board">
    ...
    <div class="container breadcrumb">
        ...
        <span>></span>
        <a href="./new_staff.php">Register Staff</a>
    </div>
    ...
    <div class="dash-container container-mid">
        <div class="contact-form" id="dash1">
            ...
            <div class="login-main-side container-mid login-grid-1" style="padding: 20px 30px;">
                <h1 style="margin: 10px 0;">Register Staff Member</h1>
            </div>

            <form action="../backend/admin/staff/create.php" method="post">

                <input class="login-input" type="text" id="username" name="username" placeholder="Username" required><br>
                <input class="login-input" type="password" id="password" name="password" placeholder="Password" required minlength="5"><br>
                ...
                <select class="login-input" name="role" id="role" style="height: inherit;">
                    ...
                    <option value="security">Cyber Security Officer</option>
...
<script>
    // alert box
    alertBox("Staff member registered successfully!", "Staff member registration failed!");
